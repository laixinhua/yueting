...
export function PlaylistDetailScreen({ playlist, onClose, headerRight }: PlaylistDetailScreenProps) {
  ...
  return (
    <Overlay title={headerTitle} onClose={onClose} headerRight={headerRight}>
      <div className="px-4 pt-4 pb-8">
        ...
        <section>
          <h3 className="text-sm font-semibold text-white/50 mb-2 px-1">歌曲列表</h3>
          {playlist.songs.length === 0 ? (
