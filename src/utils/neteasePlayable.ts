...
/** 可播探测并发 */
export const PLAYABLE_CHECK_CONCURRENCY = 8
/** 热歌/推荐池最多预检条数（够换一换即可） */
export const PLAYABLE_POOL_LIMIT = 36
/** 歌单详情页预检上限（不必扫全表） */
export const PLAYABLE_LIST_DETAIL_LIMIT = 40
/** 搜索结果预检上限 */
export const PLAYABLE_SEARCH_LIMIT = 20
