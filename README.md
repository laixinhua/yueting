...
| 类型 | 地址 |
|------|------|
| 官方直链 | https://github.com/laixinhua/yueting/releases/download/v0.5.5/yueting-debug.apk |
| 加速镜像（可试） | https://ghproxy.net/https://github.com/laixinhua/yueting/releases/download/v0.5.5/yueting-debug.apk |
| Release 页 | https://github.com/laixinhua/yueting/releases/tag/v0.5.5 |
